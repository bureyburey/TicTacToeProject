...
public class Game {
	...
	private final int START_WIN = 1;
	private final int SECOND_WIN = 2;
	private final int INCOMPLETE_TREE = 0;
	...
	public int playGame(Individual startingPlayer, Individual secondPlayer){
		...
		while(true){
			...
			if(startingPlayer.makeStrategyMove());
				...
				// abort the game
				System.out.println("Move " + startingPlayer.getValue() + " Failed");
				System.out.println("SHUTTING GAME DOWN: OBSOLETE GARBAGE");
				break;
			}
			...
			if(secondPlayer.makeStrategyMove());
				...
				System.out.println("Move " + secondPlayer.getValue() + " Failed");
				System.out.println("SHUTTING GAME DOWN: OBSOLETE GARBAGE");
				break;
			}
		...
		case SECOND_WIN:
			...
			break;
		case INCOMPLETE_TREE:
			System.out.println("Incomplete Tree Error");
			break;
		default:
